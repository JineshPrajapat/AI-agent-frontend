...
import ChatInterface from "../Component/chat/ChatInterface"; // Import the new component
...
export default function ResearchSearchApp() {
  const {
    ...
    toggleAllSelection,
    selectedCount,
    selectedPapers, // Assuming your hook provides access to selected papers
  } = usePapers();
                ...
                {selectedCount > 0 && (
                  <Box display="flex" justifyContent="flex-end">
                    <Button
                      ...
                      variant="contained"
                      sx={{ my: 2 }}
                      onClick={handleChatOpen} // Open chat on click
                    >
